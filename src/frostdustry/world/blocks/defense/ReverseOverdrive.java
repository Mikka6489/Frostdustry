...
public class ReverseOverdrive extends Block{
    @Deprecated
...
//    public @Load("@-top") TextureRegion topRegion; //
    ...
    public ReverseOverdrive(String name){
        super(name);
        solid = true;
        update = true;
    ...
    public void setBars(){
        super.setBars();
        addBar("slowdown", (OverdriveBuild entity) -> new Bar(() -> Core.bundle.format("bar.boost", Mathf.round(Math.max((entity.realBoost() * 100 - 100), 0))), () -> Pal.accent, () -> entity.realBoost() / (hasBoost ? speedBoost + speedBoostPhase : speedBoost)));
    }
    ...
    public class OverdriveBuild extends Building implements Ranged{
        ...
        public void updateTile(){
            ...
            if(charge >= reload){
                ...
                charge = 0f;
                indexer.eachBlock(this, realRange, other -> other.block.canOverdrive, other -> other.applySlowdown(realBoost(), reload + 1f));
//                indexer.eachBlock(this, realRange, other -> other.block.canOverdrive, other -> other.efficiency = 0);
            }
